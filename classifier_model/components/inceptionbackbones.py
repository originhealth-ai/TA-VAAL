...
class InceptionV4(nn.Module):
    ...
    def __init__(self,num_classes, A, B, C, k=192, l=224, m=256, n=384):
...
class InceptionResNetV2(nn.Module):
    ...
    def __init__(self, num_classes, A, B, C, k=256, l=256, m=384, n=384):
        super().__init__()
        self.stem = Inception_Stem(1)
...
def inceptionv4(num_classes,a=4,b=5,c=4):
    return InceptionV4(num_classes,a,b,c)

def inception_resnet_v2(num_classes,a=4,b=5,c=4):
    return InceptionResNetV2(num_classes,a,b,c)

if __name__ == '__main__':
    input=torch.randn(2,1,299,299)

    # 2048 x 7 x 7
    # model = inception_resnet_v2(20,3,4,3).cuda()

    # 1536 x 7 x 7
    model = inceptionv4(20,4,5,4).cuda()
